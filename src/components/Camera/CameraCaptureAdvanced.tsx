 ...
 * Full-featured camera interface with webcam integration for booking photos
 * Migrated from car-wash-booking subdirectory to preserve enhanced functionality
 */
...
interface CameraCaptureAdvancedProps {
  type: 'before' | 'after';
...
const CameraCaptureAdvanced = memo(({
  type,
  onCapture,
  onClose,
  existingPhoto
}: CameraCaptureAdvancedProps) => {
...
CameraCaptureAdvanced.displayName = 'CameraCaptureAdvanced';

export default CameraCaptureAdvanced;